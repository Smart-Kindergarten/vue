...
export default {
  ...
  methods: {
    ...
    loginOrRegister(){
      ...
      //   this.$axios.get('http://127.0.0.1:1997/register?name=' + this.loginName)
      ...
      //   this.$axios.get('http://127.0.0.1:1997/login?name=' + this.loginName)
      //     .then(function (response) {
    ...
    getSessionListNot(){
      let thus = this
      this.$axios.get('http://127.0.0.1:9901/sessionList/not?id=' + this.curUserId)
        .then(function (response) {
          if(response.data.code == -1){
            return thus.$message.error(response.data.errDesc);
          }
    ...
    sessionListAlready(){
      let thus = this
      this.$axios.get('http://127.0.0.1:9901/sessionList/already?id=' + this.curUserId)
        .then(function (response) {
          if(response.data.code == -1){
            return thus.$message.error(response.data.errDesc);
          }
    ...
    createSession(toUserId, toUserName){
      let thus = this
      this.$axios.get('http://127.0.0.1:9901/createSession?id=' + this.curUserId + "&toUserId=" + toUserId + "&toUserName=" + toUserName)
        .then(function (response) {
          if(response.data.code == -1){
            return thus.$message.error(response.data.errDesc);
          }
    ...
    delSession(sessionId){
      let thus = this
      this.$axios.get('http://127.0.0.1:9901/delSession?sessionId=' + sessionId)
        .then(function (response) {
          if(response.data.code == -1){
            return thus.$message.error(response.data.errDesc);
          }
    ...
    loginOut(){
      // let thus = this
      // this.$axios.get('http://127.0.0.1:9901/loginOut?name=' + this.curUserName)
      //   .then(function (response) {
      //     if(response.data.code == -1){
      //       return thus.$message.error(response.data.errDesc);
      //     }
    ...
    msgList(sessionId){
      let thus = this
      this.$axios.get('http://127.0.0.1:9901/msgList?sessionId=' + sessionId)
        .then(function (response) {
          if(response.data.code == -1){
            return thus.$message.error(response.data.errDesc);
          }
